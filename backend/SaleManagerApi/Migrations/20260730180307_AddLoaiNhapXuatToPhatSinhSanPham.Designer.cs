...
namespace SaleManagerApi.Migrations
{
    ...
    [Migration("20260730180307_AddLoaiNhapXuatToPhatSinhSanPham")]
    partial class AddLoaiNhapXuatToPhatSinhSanPham
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SaleManagerApi.Models.ChiTietDemKho", b =>
                {
                    ...
                    b.Property<int>("ChenhLechChan")
                        .HasColumnType("integer");

                    b.Property<int>("ChenhLechLe")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("PhieuDemKhoId")
                        .HasColumnType("integer");

                    b.Property<int>("SoDemChan")
                        .HasColumnType("integer");

                    b.Property<int>("SoDemLe")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TonChanHienTai")
                        .HasColumnType("integer");

                    b.Property<int>("TonLeHienTai")
                        .HasColumnType("integer");

                    b.HasKey("Id");

                    b.HasIndex("PhieuDemKhoId");

                    b.ToTable("ChiTietDemKhos");
                });

            modelBuilder.Entity("SaleManagerApi.Models.ChiTietDieuChuyenNoiBo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ViTriDen")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");

                    b.Property<string>("ViTriDi")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.HasIndex("LenhDieuChuyenNoiBoId");

                    b.ToTable("ChiTietDieuChuyenNoiBos");
                });
            ...
            modelBuilder.Entity("SaleManagerApi.Models.ChungTuVaoKho", b =>
                {
                    ...
                    b.Property<Guid?>("DangTaiId")
                        .HasColumnType("uuid")
                        .HasColumnName("dangtaiid");
            ...
            modelBuilder.Entity("SaleManagerApi.Models.LenhDieuChuyenNoiBo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("NguoiHoanThanh")
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
                    ...
                    b.ToTable("LenhDieuChuyenNoiBos");
                });
            ...
            modelBuilder.Entity("SaleManagerApi.Models.PhieuDemKho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SaleManagerApi.Models.Sanpham", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SaleManagerApi.Models.ChiTietDemKho", b =>
                {
                    b.HasOne("SaleManagerApi.Models.PhieuDemKho", "PhieuDemKho")
                        .WithMany("ChiTiets")
                        .HasForeignKey("PhieuDemKhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PhieuDemKho");
                });

            modelBuilder.Entity("SaleManagerApi.Models.ChiTietDieuChuyenNoiBo", b =>
                {
                    b.HasOne("SaleManagerApi.Models.LenhDieuChuyenNoiBo", "LenhDieuChuyen")
                        .WithMany("ChiTiets")
                        .HasForeignKey("LenhDieuChuyenNoiBoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LenhDieuChuyen");
                });
